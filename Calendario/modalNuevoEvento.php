    ...
    <div class="modal-content">
      ...
      <form name="formEvento" id="formEvento" action="nuevoEvento.php" class="form-horizontal" method="POST">
        ...
        <div class="col-md-12 activado">
          ...
          <label for="orange" class="circu brincolin-label">Brincolin 1</label>

          <input type="radio" name="color_evento" id="amber" value="#FFC107">  
          <label for="amber" class="circu brincolin-label">Brincolin 2</label>

          <input type="radio" name="color_evento" id="lime" value="#8BC34A">  
          <label for="lime" class="circu brincolin-label">Brincolin 3</label>

          <input type="radio" name="color_evento" id="teal" value="#009688">  
          <label for="teal" class="circu brincolin-label">Brincolin 4</label>

          <input type="radio" name="color_evento" id="blue" value="#2196F3">  
          <label for="blue" class="circu brincolin-label">Brincolin 5</label>
